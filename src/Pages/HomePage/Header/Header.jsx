    ...
    <section className="site-header">
      ...
      <div className="site-header__open-menu">
        <ul className="site-header-open-list">
          ...
          <li className="site-header__open-item open-menu-second-img">
            <a href="#" className="site-header__open-link">Регистрация</a>
          </li>
          <li className="site-header__open-item open-menu-third-img">
            <a href="#" className="site-header__open-link">Избранное</a>
          </li>
          <li className="site-header__open-item open-menu-fourth-img">
            <a href="#" className="site-header__open-link">Магазины</a>
          </li>
          <li className="site-header__open-item open-menu-fifth-img">
            <a href="#" className="site-header__open-link">Акции</a>
          </li>
          <li className="site-header__open-item open-menu-olti-img">
            <a href="#" className="site-header__open-link">Доставка 
и оплата</a>
          </li>
          <li className="site-header__open-item open-menu-margin">
      ...
      <div className="site-header__open-wrapper">
      ...
      <div className="site-header__bottom site-header__bottom-border ">
